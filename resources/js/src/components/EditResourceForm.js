...
const EditResourceForm = ({resource, handleResourceUpdate, setIsEdit}) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${BASE_URL}/api/resources/${resource.id}`, formData).then(res => {
      handleResourceUpdate(res.data.resource);
      setMsg(res.data.msg);
